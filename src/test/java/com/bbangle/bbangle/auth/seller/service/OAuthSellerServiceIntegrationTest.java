...
class OAuthSellerServiceIntegrationTest {
    ...
    void success_getSellerInfoFromRedis() {
        ...
        // when
        InfoDTO result = service.getSellerInfoFromRedis("code");
        ...
        assertThat(redisRepository.getDTOAndDelete(OAuthSellerService.OAUTH_CODE_NAMESPACE, "code", InfoDTO.class))
            .isNull();
    }
