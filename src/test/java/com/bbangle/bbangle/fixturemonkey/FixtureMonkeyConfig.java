 ...
 * <p>
 * 사용예시: 1.세세한 설정 필요 없을 시 Product product =
 * FixtureMonkeyConfig.fixtureMonkey.giveMeOne(Product.class);
 * <p>
                ...
                fixtureMonkey.giveMeBuilder(Object.class)
                    .setPostCondition(entity -> {
                        try {
                            ...
                            Map<String, Field> fields = TypeCache.getFieldsByName(
                                entity.getClass());
                            ...
                            for (Field field : fields.values()) {
                                ...
                                if (entity instanceof Member) {
                                    Field isDeletedField = entity.getClass()
