...
public class MostWishedSortRepository implements BoardSortRepository {

    private static final NumberPath<Long> CRITERIA_ATTRIBUTE = boardStatistic.boardWishCount;
    ...
    public BooleanBuilder getCursorCondition(Long cursorId) {
        ...
        Long targetWishCount = Optional.ofNullable(
        ...
        cursorBuilder.and(CRITERIA_ATTRIBUTE.lt(targetWishCount))
                .or(CRITERIA_ATTRIBUTE.eq(targetWishCount)
