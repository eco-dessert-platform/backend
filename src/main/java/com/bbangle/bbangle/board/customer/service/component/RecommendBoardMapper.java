...
public class RecommendBoardMapper {
    ...
    public List<RecommendBoardCsvDto> mapToCsvDto(Map<String, Integer> header,
        ...
        return csvData.stream().map(row -> RecommendBoardCsvDto.builder()
            ...
            .recommendationTheme(
                SimilarityTypeEnum.valueOf(row.get(header.get(RECOMMENDATION_THEME))))
    ...
    public List<RecommendationSimilarBoard> mapToEntity(
        List<RecommendBoardCsvDto> recommendBoardCsvDtoEntities) {
