...
public final class BoardResponse {
    ...
    public static BoardResponse of(BoardThumbnailDao board, boolean isBundled, List<String> tags,
        Boolean isBbangcketing, Boolean isSoldOut) {
        return BoardResponse.builder()
            .boardId(board.boardId())
            .storeId(board.storeId())
            .reviewRate(
                board.reviewRate().round(new MathContext(2, RoundingMode.HALF_UP)).doubleValue())
