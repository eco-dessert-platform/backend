package com.bbangle.bbangle.board.customer.service.mapper;
...
public interface BoardDetailInfoMapper extends CommonMapper {
    ...
    BoardDetailInfo.Product toProductInfo(Product product,
        @Context List<Long> bbangkettingProductIds);
    ...
    List<BoardDetailInfo.Product> toProductInfo(List<Product> products,
        @Context List<Long> bbangkettingProductIds);
    ...
    BoardDetailInfo.Main toMainInfo(Board board, Boolean isWishedStore, Boolean isWishedBoard,
        List<Long> bbangkettingProductIds);
