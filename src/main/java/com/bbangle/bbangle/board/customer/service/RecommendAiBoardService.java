...
import com.bbangle.bbangle.board.customer.dto.RecommendBoardCsvDto;
import com.bbangle.bbangle.board.customer.service.component.RecommendBoardFileStorageComponent;
import com.bbangle.bbangle.board.customer.service.component.RecommendBoardMapper;
...
public class RecommendAiBoardService {
    ...
    public boolean uploadAiLearningCsv() {
        RecommendLearningConfig config = recommendationLearningRepository.findById(
                RECOMMENDATION_LEARNING_CONFIG)
    ...
    private void uploadReviewCsv(RecommendLearningConfig config,
        List<AiLearningReviewDto> reviewDtos) {
