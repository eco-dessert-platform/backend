...
public class CustomerBoardController {
    ...
    public SingleResult<CursorPagination<SearchInfo.Select>> getList(
        ...
        @RequestParam(required = false, defaultValue = "RECOMMEND") SortType sort,
    ...
    public SingleResult<CursorPageResponse<BoardResponse>> getPostInFolder(
        ...
        CursorPageResponse<BoardResponse> boardResponseDto = boardService.getPostInFolder(memberId, sort, folderId,
            cursorId);
