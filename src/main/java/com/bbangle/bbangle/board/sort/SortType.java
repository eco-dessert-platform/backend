...
public enum SortType {
    ...
    RECOMMEND("추천순", () -> List.of(QRanking.ranking.recommendScore.desc(), QBoard.board.id.desc())),

    //TODO: 리뷰 많은순, 찜 많은 순, 만족도 순은 추후 리팩토링 필요
    MOST_WISHED("찜 많은 순", () -> List.of(QBoard.board.wishCnt.desc(), QBoard.board.id.desc())),
    MOST_REVIEWED("리뷰 많은 순", () -> List.of(QRanking.ranking.recommendScore.desc(), QBoard.board.id.desc())),
    HIGHEST_RATED("만족도 순", () -> List.of(QRanking.ranking.recommendScore.desc(), QBoard.board.id.desc()));
