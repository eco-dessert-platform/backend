...
public class OAuth2SellerService {
    ...
    public Optional<OAuth2Seller> findByProviderAndProviderId(OauthServerType provider, String providerId) {
        return oAuth2SellerRepository.findByProviderAndProviderId(provider, providerId);
    }
