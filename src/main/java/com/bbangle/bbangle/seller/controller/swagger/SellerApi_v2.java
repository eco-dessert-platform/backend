...
public interface SellerApi_v2 {
    ...
    CommonResult updateSeller(
        @RequestBody SellerUpdateRequest_v2 request,
    ...
    CommonResult updateStoreName(
        @RequestBody SellerStoreNameUpdateRequest_v2 request,
        @AuthenticationPrincipal Long sellerId
    );
    ...
    CommonResult updateAccount(
        @RequestBody SellerAccountUpdateRequest_v2 request,
        @AuthenticationPrincipal Long sellerId
    );
}
