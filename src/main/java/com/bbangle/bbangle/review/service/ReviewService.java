...
public class ReviewService {
    ...
    @Transactional
    public ReviewImageUploadResponse uploadReviewImage(
        ReviewImageUploadRequest reviewImageUploadRequest, Long memberId) {
        memberRepository.findMemberById(memberId);
        List<String> urls = imageService.saveAll(reviewImageUploadRequest.category(),
            reviewImageUploadRequest.images());
    ...
    public ReviewCustomPage<List<ReviewInfoResponse>> getReviews(Long boardId,
        ...
        List<ReviewSingleDto> reviewSingleList = reviewRepository.getReviewSingleList(board.getId(),
            cursorId);
    ...
    public ImageCustomPage<List<ImageDto>> getAllImagesByBoardId(Long boardId, Long cursorId) {
        List<ImageDto> allImagesByBoardId = reviewRepository.getAllImagesByBoardId(boardId,
            cursorId);
    ...
    private void updateImagePath(Long reviewId, List<String> fromPaths, List<Image> images,
        List<String> toPaths) {
