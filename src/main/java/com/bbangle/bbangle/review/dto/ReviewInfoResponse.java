...
public class ReviewInfoResponse {
    ...
    private static boolean isContainMember(ReviewSingleDto reviewSingleDto,
        Map<Long, List<Long>> likeMap, Long memberId) {
        List<Long> likeMapValue = likeMap.get(reviewSingleDto.id());
        return likeMapValue != null && likeMapValue.contains(memberId);
    }

    private static int getLikeCount(ReviewSingleDto reviewSingleDto,
        Map<Long, List<Long>> likeMap) {
        List<Long> likeMapValue = likeMap.get(reviewSingleDto.id());
