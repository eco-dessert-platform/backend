...
public class ReviewController {
    ...
    public SingleResult<ReviewCustomPage<List<ReviewInfoResponse>>> getReviews(
            ...
            Long memberId) {
        return responseService.getSingleResult(
                reviewService.getReviews(boardId, cursorId, memberId));
    }
    ...
    public CommonResult insertLike(
        ...
        reviewService.insertLike(reviewId, userPrincipal.getId());
        return responseService.getSuccessResult();
    }
    ...
    public CommonResult removeLike(
            ...
            Long reviewId,
            @AuthenticationPrincipal BbangleUserPrincipal userPrincipal) {
        reviewService.removeLike(reviewId, userPrincipal.getId());
        return responseService.getSuccessResult();
    }
    ...
    public SingleResult<ImageCustomPage<List<ImageDto>>> getAllImagesByBoardId(
            ...
            Long cursorId) {
        return responseService.getSingleResult(
                reviewService.getAllImagesByBoardId(boardId, cursorId));
    }
