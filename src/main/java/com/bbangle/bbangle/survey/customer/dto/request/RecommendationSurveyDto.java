...
public record RecommendationSurveyDto(
    ...
    public static RecommendationSurveyDto of(FoodSurvey existSurvey) {
        List<DietLimitation> dietLimitations = DietLimitations.of(
            existSurvey.getDietLimitationInfo());
        List<HealthConcern> healthConcerns = HealthConcerns.of(existSurvey.getHealthConcernInfo());
        List<UnmatchedIngredient> hateFoodList = UnmatchedIngredients.of(
            existSurvey.getUnmatchedIngredientsInfo());
        List<IsVegetarian> isVegetarians = IsVegetarians.of(existSurvey.getIsVegetarianInfo());
        return new RecommendationSurveyDto(dietLimitations, healthConcerns, hateFoodList,
            isVegetarians);
    }
